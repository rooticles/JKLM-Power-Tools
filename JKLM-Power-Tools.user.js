...
// @version      12.0
// @description  Advanced JKLM Power Tools - Ultimate Edition (v12.0)
// @author       Root
            ...
            const updateKbContent = () => {
                ...
                <div class="custom-page-content">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            ...
                            <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.05); display: flex; align-items: center; gap: 12px; opacity: 0.9; transition: 0.3s;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.9'">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 2px;">
                                    ...
                                    <a href="https://discord.com/users/eliplay24" target="_blank" style="display: flex; align-items: center; gap: 4px; color: #5865F2; text-decoration: none; font-size: 10px; font-weight: 700; margin-top: 2px; opacity: 0.8; transition: 0.3s;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.8'">
                    ...
                    <div class="feature-card" style="background: rgba(var(--theme-color-rgb), 0.05); border-color: rgba(var(--theme-color-rgb), 0.2);">
                        ...
                        <a href="https://discord.com/users/rooticles." target="_blank" style="display: flex; align-items: center; gap: 8px; background: #5865F2; color: white; padding: 8px 16px; border-radius: 10px; text-decoration: none; font-weight: 800; font-size: 12px; transition: 0.3s; width: fit-content; box-shadow: 0 4px 15px rgba(88, 101, 242, 0.3);" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 20px rgba(88, 101, 242, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(88, 101, 242, 0.3)'">
